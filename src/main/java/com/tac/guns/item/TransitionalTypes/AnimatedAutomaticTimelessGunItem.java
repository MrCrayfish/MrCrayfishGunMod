...
public class AnimatedAutomaticTimelessGunItem extends AutomaticTimelessGunItem implements IAnimatable,ITimelessAnimated {
    public static final String CONTROLLER_NAME = "gunStatusController";

    public AnimatedAutomaticTimelessGunItem(Process<Properties> properties, ForgeConfigSpec.IntValue TRIG_MAX,  Supplier<Callable<ItemStackTileEntityRenderer>> ister) {
        super(p-> properties.process(p.setISTER(ister)) , TRIG_MAX);
    }
