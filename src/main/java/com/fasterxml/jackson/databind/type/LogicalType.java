 ...
 * physical types ({@link Class} or {@link com.fasterxml.jackson.databind.JavaType}).
 *
 * @since 2.12
 */
public enum LogicalType
{
     ...
     * or even just nominal type of {@link Object}
     */
    Untyped,
    ...
    /**
     * Purely textual types, {@link String} and similar (but not types that
