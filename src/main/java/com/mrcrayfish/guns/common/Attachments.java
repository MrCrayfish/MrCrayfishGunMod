...
{
    public static final Scope SHORT_SCOPE = Scope.builder().additionalZoom(0.1F).centerOffset(1.55F).viewFinderOffset(1.0).aimFov(20.0).modifiers(GunModifiers.SLOW_ADS).build();
