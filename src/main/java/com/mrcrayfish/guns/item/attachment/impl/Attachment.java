...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(new TranslationTextComponent("perk.cgm.title").applyTextStyle(TextFormatting.GRAY).applyTextStyle(TextFormatting.BOLD));
    ...
    {
        components.add(new TranslationTextComponent(positive ? "perk.cgm.entry.positive" : "perk.cgm.entry.negative", new TranslationTextComponent(id, params).applyTextStyle(TextFormatting.WHITE)).applyTextStyle(positive ? TextFormatting.DARK_AQUA : TextFormatting.GOLD));
    }
}
