...
public class ModItems
{
    ...
    public static final RegistryObject<Item> LMG = REGISTER.register("lmg", () -> new GunItem(new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    ...
    public static final RegistryObject<Item> LIGHT_MUZZLE_BREAK = REGISTER.register("light_muzzle_break", () -> new BarrelItem(Barrel.create(9.0F, GunModifiers.LIGHT_RECOIL), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> MUZZLE_BREAK = REGISTER.register("muzzle_break", () -> new BarrelItem(Barrel.create(9.0F, GunModifiers.REDUCED_RECOIL), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
    public static final RegistryObject<Item> SNIPER_MUZZLE_BREAK = REGISTER.register("sniper_muzzle_break", () -> new BarrelItem(Barrel.create(9.0F, GunModifiers.SNIPER_RECOIL), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
