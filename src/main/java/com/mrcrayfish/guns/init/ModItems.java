...
public class ModItems
{
    ...
    public static final RegistryObject<Item> LONG_SCOPE = REGISTER.register("long_scope", () -> new ScopeItem(Scope.create(0.35F, 1.59, 3.5F, 3.0F), new Item.Properties().maxStackSize(1).group(GunMod.GROUP)));
