...
public class ModItems
{
    ...
    public static final RegistryObject<Item> MEDIUM_SCOPE = REGISTER.register("medium_scope", () -> new ScopeItem(Scope.create(0.2F, 2.1F), new Item.Properties().maxStackSize(1)));
    public static final RegistryObject<Item> LONG_SCOPE = REGISTER.register("long_scope", () -> new ScopeItem(Scope.create(0.35F, 1.59F), new Item.Properties().maxStackSize(1)));
