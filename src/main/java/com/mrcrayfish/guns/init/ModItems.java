...
public class ModItems
{
    ...
    public static final RegistryObject<Item> LASER_SIGHT = REGISTER.register("laser_sight", () -> new BarrelItem(Barrel.create(4.0F, GunModifiers.LASER), new Item.Properties().stacksTo(1).tab(GunMod.GROUP)));
