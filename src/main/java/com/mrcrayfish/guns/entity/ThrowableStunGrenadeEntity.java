...
public class ThrowableStunGrenadeEntity extends ThrowableGrenadeEntity
{
    ...
    private boolean calculateAndApplyEffect(Effect effect, EffectCriteria criteria, LivingEntity entity, Vec3d grenade, Vec3d eyes, double distance, double angle)
    {
