...
public class EntityThrowableGrenade extends EntityThrowableItem
{
    ...
    private static void createGrenadeExplosion(EntityThrowableGrenade grenade, Entity thrower, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking)
    {
        ...
        Explosion explosion = new ExplosionGrenade(grenade.world, grenade, thrower, x, y, z, strength, isFlaming, canGunGrief);
                ...
                if(!entity.isImmuneToExplosions())
                {
                    ...
                    if(distanceToExplosion <= 1.0D)
                    {
                        ...
                        if(deltaDistance != 0.0D)
                        {
                            ...
                            entity.attackEntityFrom(new DamageSourceProjectile("grenade", grenade, exploder, new ItemStack(ModGuns.GRENADE)), (float) ((int) ((damage * damage + damage) / 2.0D * 7.0D * (double) doubleSize + 1.0D)));
